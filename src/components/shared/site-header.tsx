    ...
    <header className="sticky top-0 z-50 border-b border-white/10 bg-slate-950/85 backdrop-blur-xl">
      <div className="mx-auto flex w-full max-w-7xl items-center justify-between gap-4 px-4 py-3 sm:px-6 lg:px-8">
        <Link href="/" className="flex items-center gap-3" aria-label="Irongate Locksmiths home">
          <Image src="/branding/irongate-logo-mark.svg" alt="Irongate shield icon" width={44} height={44} className="h-11 w-11" />
          <Image
            src="/branding/irongate-logo-full.svg"
            alt="Irongate South Shields Locksmith Service"
            width={350}
            height={72}
            className="hidden h-auto w-[250px] md:block"
            priority
          />
        </Link>
